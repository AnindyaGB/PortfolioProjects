<?php
    ...
    $query = 'UPDATE personnel SET firstName = "' . $_REQUEST['firstName'] . '", lastName = "' . $_REQUEST['lastName'] . '", jobTitle = "' . $_REQUEST['jobTitle'] . '", email = "' . $_REQUEST['email'] . '", departmentID = ' . $_REQUEST['departmentID'] . ' WHERE email =  "'. $_REQUEST['emailOld'].'"';


    //$query = "UPDATE personnel SET firstName = 'Anindya', lastName = 'Bhattacharyya', jobTitle = 'Shuggur', email = 'anindya.gopal.b@gmail.com', departmentID = 1 WHERE Id = 1";
